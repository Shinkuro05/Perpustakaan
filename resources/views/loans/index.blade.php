...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
    <div class="flex gap-3">
        <div class="relative sm:w-64">
            ...
            <input type="text" id="searchInput" placeholder="Cari anggota, buku..." value="{{ request('search') }}"
    ...
    <a href="{{ route('loans.create') }}" class="btn-primary whitespace-nowrap">
...
<div class="card overflow-hidden">
    <div id="loansTable">
        @include('loans.partials.table', ['loans' => $loans])
    </div>
</div>
...
function fetchLoans() {
    ...
    fetch(`{{ route('loans.index') }}?${params}`, {
